...
MIT, currently v0.11.0 — the engine pins `vle-thermo = "0.11"` with the
`component-db` feature; M2 needed 0.11's NRTL model + ammonia component). It
adds no thermodynamics of its own — it is the first
